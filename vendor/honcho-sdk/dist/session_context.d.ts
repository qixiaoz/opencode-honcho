 ...
 */
export declare class SessionSummaries {
    /**
     * The session ID.
     */
    readonly id: string;
    ...
    constructor(id: string, shortSummary: Summary | null, longSummary: Summary | null);
...
export declare class SessionContext {
     ...
     */
    constructor(sessionId: string, messages: Message[], summary?: Summary | null, peerRepresentation?: string | null, peerCard?: string[] | null);
    /**
     ...
     */
    toAnthropic(assistant: string | Peer): Array<{
        role: string;
        content: string;
    }>;
    /**
     ...
     */
    static fromApiResponse(sessionId: string, data: SessionContextResponse): SessionContext;
    /**
